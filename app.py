...
app = FastAPI(
    ...
    description="AI-powered news analyst delivering personalized briefings and in-depth story analysis.",
    lifespan=lifespan,
)
...
class AskRequest(BaseModel):
    ...
    model_config = {"json_schema_extra": {"examples": [{"query": "What's happening in AI today?", "session_id": None, "response_format": "detailed", "model_id": None}]}}
        ...
        try:
            ...
            try:
                ...
                await MongoDB.save_conversation(
                    ...
                    steps=raw_stream.steps,
                    user_id=user_id,
                    plan=raw_stream.plan,
                )
            except Exception as e:
